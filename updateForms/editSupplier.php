        ...
        <form action="updateSupplier.php" method="POST" class="w-75 h-100 mx-auto p-3 needs-validation" id="form" novalidate>
            ...
            <div class="container row">
                ...
                <div class="col mb-3">
                    ...
                    <input type="date" class="form-control" id="supp-dob" name="supp-dob" value="<?php echo htmlspecialchars($row['dob']); ?>" required>
                </div>
            </div>
            ...
            <div class="container row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="manager-first-name" name="manager-first-name"
                        placeholder="First Name" value="<?php echo htmlspecialchars($row['manager_first_name']); ?>" pattern="^[A-Za-z\s]+$" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="manager-middle-name" name="manager-middle-name"
                        placeholder="Middle Name" value="<?php echo htmlspecialchars($row['manager_middle_name']); ?>" pattern="^[A-Za-z\s]+$">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="manager-last-name" name="manager-last-name"
                        placeholder="Last Name" value="<?php echo htmlspecialchars($row['manager_last_name']); ?>" pattern="^[A-Za-z\s]+$" required>
                    <div class="invalid-feedback">
