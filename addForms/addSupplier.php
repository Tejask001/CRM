    ...
    if (empty($comp_pan_no) || !preg_match("/^[A-Za-z0-9]{10}$/", $comp_pan_no)) {
     ...
     if (empty($errors)) {
          ...
          $sql = "INSERT INTO `amba_associats`.`supplier` (
            ...
            `manager_first_name`, `manager_middle_name`, `manager_last_name`, `manager_phone`, 
            `manager_email`, `chemical_license`, `comp_email`, `comp_address`, `trader_id`, 
            `gst_no`, `pan_no`, `tan_no`, `website`, `remarks`
        ) VALUES (
            '$supp_first_name', '$supp_middle_name', '$supp_last_name', '$supp_dob', 
            '$supp_phone', '$supp_email', '$supp_address', '$comp_first_name', 
            '$comp_middle_name', '$comp_last_name', '$comp_type', '$manager_first_name', 
            '$manager_middle_name', '$manager_last_name', '$manager_phone', 
            '$manager_email', '$comp_chemical_license', '$comp_email', '$comp_address', 
            '$comp_trader_id', '$comp_gst_no', '$comp_pan_no', '$comp_tan_no', 
            '$comp_website', '$remarks'
        )";
    ...
    <div class="container bg-body-tertiary mw-100 h-100">
        <form action="addSupplier.php" method="POST" class="w-75 h-100 mx-auto p-3 needs-validation" id="form" novalidate>
            ...
            <div class="container row">
                ...
                <div class="col mb-3">
                    <label for="supp-dob">Supplier's DOB *</label>
                    <input type="date" class="form-control" id="supp-dob" name="supp-dob" placeholder="Date of Birth" required>
                </div>
            </div>
            ...
            <div class="container row">
                <div class="col-md-3 mb-3">
                    <label for="manager-first-name">Manager's First Name *</label>
                    <input type="text" class="form-control" id="manager-first-name" name="manager-first-name"
                        placeholder="First Name" pattern="^[A-Za-z\s]+$" required>
                    <div class="invalid-feedback">
                    <?php echo $errors['manager-first-name'] ?? 'Please Use Alphabets Only'; ?>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <label for="manager-middle-name">Manager's Middle Name</label>
                    <input type="text" class="form-control" id="manager-middle-name" name="manager-middle-name"
                        placeholder="Middle Name" pattern="^[A-Za-z\s]+$">
                    <div class="invalid-feedback">
                    <?php echo $errors['manager-middle-name'] ?? 'Please Use Alphabets Only'; ?>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <label for="manager-last-name">Manager's Last Name *</label>
                    <input type="text" class="form-control" id="manager-last-name" name="manager-last-name"
                        placeholder="Last Name" pattern="^[A-Za-z\s]+$" required>
                    <div class="invalid-feedback">
                    <?php echo $errors['manager-last-name'] ?? 'Please Use Alphabets Only'; ?>
                    </div>
                </div>
            </div>
